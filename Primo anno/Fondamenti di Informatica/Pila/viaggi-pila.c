...
void eliminazione(struct Nodo** pila, char nome[50]);
void ricerca(struct Nodo* pila, char destinazione[50]);
int dimensione(struct Nodo* pila);
...
void visualizzazione(struct Nodo* pila) {
    ...
    while (pila != NULL) {
        ...
        printf("\tNome passeggero: %s\n\tDestinazione viaggio: %s\n\tData viaggio: %s\n\n", pila->prenotazione.nome, pila->prenotazione.destinazione, pila->prenotazione.data);
...
void ricerca(struct Nodo* pila, char destinazione[50]) {
    ...
    while (pila != NULL) {
        if (strcmp(pila->prenotazione.destinazione, destinazione) == 0) {
            printf("\nPRENOTAZIONE %d\n", i);
            printf("\tNome passeggero: %s\n\tDestinazione viaggio: %s\n\tData viaggio: %s\n\n", pila->prenotazione.nome, pila->prenotazione.destinazione, pila->prenotazione.data);
